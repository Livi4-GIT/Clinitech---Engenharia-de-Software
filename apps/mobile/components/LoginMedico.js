...
export default class LoginMedico extends React.Component {
  ...
  entrar = async () => {
    ...
    if (!data) return Alert.alert("Credenciais inválidas", "CRM não cadastrado.");
    const medico = JSON.parse(data);
    if (medico.senha !== senha) return Alert.alert("Credenciais inválidas", "Senha incorreta.");
            ...
            <View style={styles.center}>
              ...
              <View style={styles.card}>
                ...
                <View style={styles.inputWrap}>
                  <MaterialCommunityIcons name="stethoscope" size={20} color="#d6e4ff" style={{ marginRight: 8 }} />
                  <TextInput
                    style={styles.input}
