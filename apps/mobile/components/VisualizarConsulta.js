...
export default function VisualizarConsulta({ onVoltar }) {
  return (
    <LinearGradient
    ...
    >
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <View style={styles.headerBar}>
          ...
          <Text style={styles.headerTitle}>Visualizar Consultas</Text>
          <View style={{ width: 34 }} />
        </View>

        <View style={styles.content}>
          <Text style={styles.text}>Aqui você pode visualizar todas as consultas.</Text>
        </View>
      </SafeAreaView>
    </LinearGradient>
  );
